...
def admin_dashboard_ui():
    ...
    # Usar st.components.html() para renderizar el HTML
    html_code = """
    ...
    # Renderizar el HTML (con unsafe_allow_html=True)
    st.components.html(html_code, height=500)
    
    # Alternativa usando markdown
